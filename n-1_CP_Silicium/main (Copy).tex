...
\lfoot{IUT d'Orsay - BUT 2 MAT - 2024-2025} \cfoot{\includegraphics[height=0.5cm]{cc-by-nc-sa.png}}  \rfoot{Jean-François Olivieri \quad \thepage}
...
\captionof{table}{Températures de fusion de quelques corps purs représentatifs de l'évolution humaine à pression atmosphérique.}
\end{minipage}
\end{center}
...
\definition{L'axe des ordonnées représente $RT \ln \frac{P_{\ce{P2}}}{P^\circ}$. Par conséquent, plus on monte sur l'axe des ordonnées, plus la pression en dioxygène est importante.
\begin{center}
\begin{minipage}{0.48\textwidth}
\centering
