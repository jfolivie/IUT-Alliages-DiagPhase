\subsection{Polymorphisme du carbonate de calcium}
...
\Q Déterminer l'accroissement d'enthalpie libre pour la transition calcite $\to$ aragonite à \SI{25}{\celsius} sous une pression d'une atmosphère.

\Q Laquelle des deux formes est la plus stable dans ces conditions ?

\Q De combien faut-il accroître la pression, la température restant constante, pour que l'autre forme devienne stable ?
