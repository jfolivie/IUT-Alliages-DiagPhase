\begin{exercise}[Surfusion du phosphore]
...
\begin{questions}
\question On fait cesser la surfusion et on observe un nouvel état d'équilibre diphasé du phosphore. Déterminer la masse respective de chacune des phases.
...
\question Calculer la variation d'entropie correspondante.

\question Quel serait l'état final du système si on faisait cesser la surfusion d'une même masse de phosphore initialement à la température $T_0' = 17.5 ~ \si{\celsius}$ ?
\end{questions}
