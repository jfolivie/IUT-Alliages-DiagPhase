\begin{exercise}[Changement d'état de l'eau]
...
\begin{questions}
\question Proposer un schéma de la transformation, étape par étape.

\question Calculer les variations $\Delta H$ et $\Delta U$ du corps pur.
\end{questions}
...
& \rho(\ce{H2O}, s) = 9.18 \cdot 10^2 ~ \si{\kilo\gram\per\meter\cubed} ; \rho (\ce{H2O}, l) = 1.00\cdot 10^3 ~ \si{\kilo\gram\per\meter\cubed} ; \\
